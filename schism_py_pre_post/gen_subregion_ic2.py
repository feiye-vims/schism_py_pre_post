...
for var in ['tem', 'sal']:
    ...
    f_usgs_coastal = f'/sciclone/schism10/feiye/From_Nabi/RUN02/Hotstart_v1/Obs/mean_{var}_xyz_2012-10-15'
    ...
    f_HYCOM = '/sciclone/schism10/feiye/Coastal_Act/Hot/13c/TS_1.nc'
